...
void display(void)
{
   ...
   glLoadIdentity();
   light_position[0] = 10.0 * sin(spin*PI/360);
   light_position[2] = 10.0 * cos(spin*PI/360);
...
int main(int argc, char** argv)
{
   ...
   glutCreateWindow ("Moving Light Source with Viewpoint");
   init ();
...
/* By Binh Le, modifed from the original program in the red book */
