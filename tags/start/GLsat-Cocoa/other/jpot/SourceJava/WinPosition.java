...
public class WinPosition extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "WinPosition.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "WinPosition";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X ", 0, 200, 0, 'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y ", 0, 200, 0, 'c');
		vSlider.addElement(slider);
	}
	...
	public WinPosition() {
		...
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) { 
				//File fp = new File("JPotProcessID.WinPosition");
	...
	private void killUNIXProcess() {
	    Runtime program = Runtime.getRuntime();
	    try {
		pid = program.exec("trigger WinPosition");
	    }
	    catch (IOException ie) {
