...
public class OrthoProjection extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "OrthoProjection.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "OrthoProjection";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "OrthoProjection.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("left",-10.0,10.0,-5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("right",-10.0,10.0,5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("bottom",-10.0,10.0,-5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("top",-10.0,10.0,5.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("near",-10.0,10.0,2.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("far",10.0,30.0,20.0,'c');
		vSlider.addElement(slider);
