...
public class FogExample1 extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "FogExample1.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "FogExample1";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"FogExample1.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"FogExample1.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"FogExample1.swap2";
    final String radLabel1 = " GL_LINEAR";
    final String radLabel2 = " GL_EXP";
    /**
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Density",0.0,1.0,0.35,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Start",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Finish",0.0,1.0,0.5,'c');
		vSlider.addElement(slider);
	}
