...
public class MatSpec extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MatSpec.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MatSpec";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MatSpec.dat";
