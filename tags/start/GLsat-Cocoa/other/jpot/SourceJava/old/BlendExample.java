...
public class BlendExample extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "BlendExample.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "BlendExample";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "BlendExample.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Alpha",0.0,1.0,0.5,'c');
