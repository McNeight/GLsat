...
public class DrawingObj extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "DrawingObj.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "DrawingObj";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "DrawingObj.dat";
