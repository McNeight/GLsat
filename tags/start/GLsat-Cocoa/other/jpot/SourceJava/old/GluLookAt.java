...
public class GluLookAt extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "GluLookAt.html";
	/**
	 * Number of sliders used in the frame.
	 */
	static int COMPONENTS = 9;
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "GluLookAt";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "GluLookAt.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("cameraX",-10.0,10.0,3.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("cameraY",-10.0,10.0,4.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("cameraZ",-15.0,15.0,10.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("aimX",-5.0,5.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("armY",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("armZ",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("upVecX",-1.0,1.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("upVecY",-1.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("upVecZ",-1.0,1.0,0.0,'c');
		vSlider.addElement(slider);
	}
