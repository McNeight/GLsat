...
public class HidSurRem extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "HidSurRem.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "HidSurRem";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"HidSurRem.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"HidSurRem.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"HidSurRem.swap2";
    final String radLabel1 = " Enable Depth Buffer";
    final String radLabel2 = " Disable Depth Buffer";
    /**
