...
public class MatAmbience extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MatAmbience.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MatAmbience";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MatAmbience.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Red",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Green",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Blue",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
	}
