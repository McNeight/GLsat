...
public class DiffLight extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "DiffLight.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "DiffLight";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "DiffLight.dat";
