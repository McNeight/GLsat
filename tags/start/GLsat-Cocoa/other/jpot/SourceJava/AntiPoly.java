...
public class AntiPoly extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "AntiPoly.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "AntiPoly";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"AntiPoly.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"AntiPoly.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"AntiPoly.swap2";
    final String radLabel1 = " AntiAliased";
    final String radLabel2 = " Aliased";
    /**
