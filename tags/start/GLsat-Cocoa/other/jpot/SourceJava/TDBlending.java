...
public class TDBlending extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "TDBlending.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "TDBlending";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"TDBlending.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"TDBlending.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"TDBlending.swap2";
    final String radLabel1 = " Black box, Cyan box, Sphere";
    final String radLabel2 = " Sphere, Cyan box, Black box";
    /**
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Alpha blackbox",0.0,1.0,0.2,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Alpha cyanbox",0.0,1.0,0.6,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Alpha sphere",0.0,1.0,0.1,'c');
		vSlider.addElement(slider);
	}
