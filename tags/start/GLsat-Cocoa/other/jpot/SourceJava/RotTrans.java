...
public class RotTrans extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "RotTrans.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "RotTrans";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "RotTrans.dat";
	...
	void createSliderVector() { 
		...
		vSlider.addElement(slider);
		slider = new PSlider("Angle",-180.0,180.0,0.0,'n');
		vSlider.addElement(slider);
