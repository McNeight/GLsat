...
GLfloat JPOT$8 = 20.0;
GLfloat JPOT$9 = 5.0;
GLfloat JPOT$10 = 25.0;
GLfloat JPOT$11 = 20.0;
char *datafile = "DrawTriangle.dat";
...
void ReadData(void) {
	if ((fp = fopen(datafile, "r")) == NULL)
	{
		...
		while ( !feof(fp)) {
fscanf(fp," %d %f %f %f %f %f %f %f %f %f %f", &JPOT$1, &JPOT$2, &JPOT$3, &JPOT$4, &JPOT$5, &JPOT$6, &JPOT$7, &JPOT$8, &JPOT$9, &JPOT$10, &JPOT$11);
		}
		fclose(fp);
	}
}
