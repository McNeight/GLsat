...
void display(void)
{
   ...
   /*$$$
     [Quad Mode, s, GL_QUADS, GL_QUADS 7 GL_QUAD_STRIP 8, c]
     $$$*/
   glBegin(JPOT$1);
  /*$$$
     [X0, f, 5.0, 0.0, 30.0, n], [Y0, f, 5.0, 0.0, 30.0, c],
     [X1, f,15.0, 0.0, 30.0, c], [Y1, f,10.0, 0.0, 30.0, c],
     [X2, f,10.0, 0.0, 30.0, n], [Y2, f,10.0, 0.0, 30.0, c],
     [X3, f,12.0, 0.0, 30.0, c], [Y3, f,20.0, 0.0, 30.0, c],
     [X4, f,15.0, 0.0, 30.0, n], [Y4, f, 3.0, 0.0, 30.0, c],
     [X5, f,15.0, 0.0, 30.0, c], [Y5, f,20.0, 0.0, 30.0, c],
     [X6, f,25.0, 0.0, 30.0, n], [Y6, f, 6.0, 0.0, 30.0, c],
     [X7, f,22.0, 0.0, 30.0, c], [Y7, f,22.0, 0.0, 30.0, c],
     $$$*/
