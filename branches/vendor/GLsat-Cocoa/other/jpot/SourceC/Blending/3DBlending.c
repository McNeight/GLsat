...
void display(void)
{
   ...
   /*$$$[Alpha blackbox, f, 0.2, 0.0, 1.0, c]$$$*/
   mat_amb_diff_black[3] = JPOT$1;
   /*$$$[Alpha cyanbox, f, 0.6, 0.0, 1.0, c]$$$*/
   mat_amb_diff_cyan[3] = JPOT$2;
   /*$$$[Alpha sphere, f, 0.1, 0.0, 1.0, c]$$$*/
   mat_amb_diff_red[3] = JPOT$3;
   /*$$$swap-flip Black box, Cyan box, Sphere$$$*/
   glPushMatrix();
   ...
   glFlush();
   /*$$$swap-end$$$*/
   /*$$$swap-flop Sphere, Cyan box, Black box $$$*/
   glPushMatrix();
   glTranslatef(1.5, 0.0, -2.0);
   glMaterialfv(GL_FRONT, GL_SHININESS, mat_shininess);  
   glMaterialfv(GL_FRONT, GL_AMBIENT_AND_DIFFUSE, mat_amb_diff_red);
