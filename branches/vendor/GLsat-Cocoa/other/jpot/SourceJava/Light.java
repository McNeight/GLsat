...
public class Light extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "Light.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "Light";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "Light.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Light X",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Light Y",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Light Z",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Light W",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Amb_Red",0.0,1.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Amb_Green",0.0,1.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Amb_Blue",0.0,1.0,0.0,'c');
		vSlider.addElement(slider);
