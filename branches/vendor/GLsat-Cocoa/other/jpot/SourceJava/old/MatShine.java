...
public class MatShine extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MatShine.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MatShine";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MatShine.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Shininess",0,100,50,'c');
