...
public class MatrixSpec extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MatrixSpec.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MatrixSpec";
