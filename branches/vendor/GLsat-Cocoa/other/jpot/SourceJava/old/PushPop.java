...
public class PushPop extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "PushPop.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "PushPop";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"PushPop.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"PushPop.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"PushPop.swap2";
    final String radLabel1 = " With Push/Pop";
    final String radLabel2 = " Without Push/Pop";
    /**
	...
	void createSliderVector() { 
		...
		vSlider.addElement(slider);
		slider = new PSlider("Z1",-5.0,5.0,3.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X2",-5.0,5.0,3.0,'n');
		vSlider.addElement(slider);
