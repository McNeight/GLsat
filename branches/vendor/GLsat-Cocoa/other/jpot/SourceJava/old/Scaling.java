...
public class Scaling extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "Scaling.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "Scaling";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X",0.0,3.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y",0.0,3.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X",0.0,3.0,1.0,'c');
		vSlider.addElement(slider);
	}
