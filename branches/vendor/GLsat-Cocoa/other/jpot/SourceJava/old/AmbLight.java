...
public class AmbLight extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "AmbLight.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "AmbLight";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "AmbLight.dat";
