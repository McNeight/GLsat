...
public class MatDiffuse extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MatDiffuse.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MatDiffuse";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MatDiffuse.dat";
