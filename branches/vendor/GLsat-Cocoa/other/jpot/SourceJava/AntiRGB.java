...
public class AntiRGB extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "AntiRGB.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "AntiRGB";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"AntiRGB.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"AntiRGB.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"AntiRGB.swap2";
    final String radLabel1 = " Enable Antialiasing";
    final String radLabel2 = " Disable Antialiasing";
    /**
