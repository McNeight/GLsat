...
{ 
  ...
  /*$$$
    [Red, f, 1.0, 0.0, 1.0, c], [Green, f, 1.0, 0.0, 1.0, c],[Blue, f, 1.0, 0.0, 1.0, c]
    $$$*/
  material_specular[0] = JPOT$1;
  material_specular[1] = JPOT$2;
  material_specular[2] = JPOT$3;
...
int main(int argc, char** argv)
{
   ...
   glutCreateWindow ("Material Specular");
   init ();
