...
public class Lighting extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "Lighting.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "Lighting";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"Lighting.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"Lighting.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"Lighting.swap2";
    final String radLabel1 = " Enable Lighting";
    final String radLabel2 = "";
    /**
