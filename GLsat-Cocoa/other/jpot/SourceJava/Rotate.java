...
public class Rotate extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "Rotate.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "Rotate";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "Rotate.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Angle",-90.0,90.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X",-5.0,5.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Y",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Z",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
	}
