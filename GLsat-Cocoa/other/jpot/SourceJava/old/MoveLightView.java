...
public class MoveLightView extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "MoveLightView.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "MoveLightView";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"MoveLightView.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"MoveLightView.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"MoveLightView.swap2";
    final String radLabel1 = " View Front Side";
    final String radLabel2 = " View Back Side";
    /**
