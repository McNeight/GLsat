...
public class MulObjTrans extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MulObjTrans.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MulObjTrans";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MulObjTrans.dat";
