...
public class MultiObjTrans extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MultiObjTrans.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MultiObjTrans";
