...
public class OrderTrans2 extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "OrderTrans2.html";
    /**
     * Number of sliders used in the frame.
     */
    static int COMPONENTS = 7;
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "OrderTrans2";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"OrderTrans2.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"OrderTrans2.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"OrderTrans2.swap2";
    final String radLabel1 = " Translate then Rotate";
    final String radLabel2 = " Rotate then Translate";
    /**
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X1",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y1",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Z1",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Angle",-90.0,90.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("X2",-5.0,5.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Y2",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Z2",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
	}
