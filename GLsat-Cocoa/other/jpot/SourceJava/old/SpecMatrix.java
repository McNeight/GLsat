...
public class SpecMatrix extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "SpecMatrix.html";
	/**
	 * Number of sliders used in the frame.
	 */
	static int COMPONENTS = 16;
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "SpecMatrix";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "SpecMatrix.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("0:",-3.0,3.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("1:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("2:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("3:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("4:",-3.0,3.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("5:",-3.0,3.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("6:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("7:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("8:",-3.0,3.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("9:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("10:",-3.0,3.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("11:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("12:",-3.0,3.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("13:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("14:",-3.0,3.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("15:",-3.0,3.0,1.0,'c');
		vSlider.addElement(slider);
	}
