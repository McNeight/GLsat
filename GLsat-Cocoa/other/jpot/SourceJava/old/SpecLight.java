...
public class SpecLight extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "SpecLight.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "SpecLight";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "SpecLight.dat";
