...
public class Viewport extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "Viewport.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "Viewport";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"Viewport.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"Viewport.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"Viewport.swap2";
    final String radLabel1 = " One Viewport";
    final String radLabel2 = " Two Viewports";
    /**
