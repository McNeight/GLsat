...
public class RotationRedBook extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "RotationRedBook.html";
	/**
	 * Name of the executable file illustrates for the example.
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "RotationRedBook";
	// End of the vary part.

		
	public RotationRedBook() {
		super(windowTitle);
		int i;
