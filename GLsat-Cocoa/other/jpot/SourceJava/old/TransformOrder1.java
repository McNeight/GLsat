...
public class TransformOrder1 extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "TransformOrder1.html";
	/**
	 * Name of the executable file illustrates for the example.
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "TransformOrder1";
	// End of the vary part.

		
	public TransformOrder1() {
		super(windowTitle);
		int i;
