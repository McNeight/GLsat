...
public class PersProjection extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "PersProjection.html";
	/**
	 * Number of sliders used in the frame.
	 */
	static int COMPONENTS = 15;
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "PersProjection";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "PersProjection.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("left",-10.0,10.0,-1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("right",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("bottom",-10.0,10.0,-1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("top",-10.0,10.0,1.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("near",0.1,20.0,2.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("far",0.1,30.0,20.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("eye-x",-10.0,10.0,2.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("eye-y",-10.0,10.0,4.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("eye-z",-20.0,20.0,13.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("center-x",-5.0,5.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("center-y",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("center-z",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("up-x",-1.0,1.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("up-y",-1.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("up-z",-1.0,1.0,0.0,'c');
		vSlider.addElement(slider);
	}
