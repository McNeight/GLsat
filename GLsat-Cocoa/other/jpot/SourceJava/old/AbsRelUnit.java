...
public class AbsRelUnit extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "AbsRelUnit.html";
	/**
	 * Number of sliders used in the frame.
	 */
	static int COMPONENTS = 4;
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "AbsRelUnit";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "AbsRelUnit.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("left",-1.0,1.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("right",-1.0,1.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("bottom",-1.0,1.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("top",-1.0,1.0,1.0,'c');
		vSlider.addElement(slider);
	}
