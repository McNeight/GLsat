...
public class DrawingObject extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "DrawingObject.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "DrawingObject";
