...
public class RotTrans2 extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "RotTrans2.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "RotTrans2";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"RotTrans2.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"RotTrans2.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"RotTrans2.swap2";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Xt",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Yt",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Xt",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Angle",-90.0,90.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Xr",-5.0,5.0,0.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Yr",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Zr",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
	}
