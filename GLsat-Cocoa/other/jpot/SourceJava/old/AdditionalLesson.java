...
public class AdditionalLesson extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "AdditionalLesson.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "AdditionalLesson";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("x1",0.0,1.0,0.25,'c');
		vSlider.addElement(slider);
		slider = new PSlider("y1",0.0,1.0,0.25,'c');
		vSlider.addElement(slider);
		slider = new PSlider("x2",0.0,1.0,0.75,'n');
		vSlider.addElement(slider);
		slider = new PSlider("y2",0.0,1.0,0.25,'c');
		vSlider.addElement(slider);
		slider = new PSlider("x3",0.0,1.0,0.75,'n');
		vSlider.addElement(slider);
		slider = new PSlider("y3",0.0,1.0,0.75,'c');
		vSlider.addElement(slider);
	}
...
/*	
	public static void main(String argc[]) {
		...
		AdditionalLesson add = new AdditionalLesson();
