...
public class MultObjTrans extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "MultObjTrans.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "MultObjTrans";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "MultObjTrans.dat";
	...
	void createSliderVector() { 
		...
		vSlider.addElement(slider);
		slider = new PSlider("X2",-6.0,6.0,3.0,'n');
		vSlider.addElement(slider);
