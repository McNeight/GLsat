...
public class BackColor extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "BackColor.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "BackColor";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "BackColor.dat";
