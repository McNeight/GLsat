...
public class LightSource extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "LightSource.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "LightSource";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "LightSource.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Z",-10.0,10.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("W",0.0,1.0,1.0,'c');
		vSlider.addElement(slider);
	}
