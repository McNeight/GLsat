...
public class FogExample2 extends JFrame {
     ...
     */
    static String exampleSource = "html" + System.getProperty("file.separator") + "FogExample2.html";
    /**
     ...
     */
     String cmd = "ogl" + System.getProperty("file.separator") + "FogExample2";
 
    /**
      * Data file to provide interchance data during the interaction
      */
    String dataFile = 	"FogExample2.dat";

    /**
     * Strings to process the code-swap parts
     */
    final String fileStr1 = "html" + System.getProperty("file.separator") +"FogExample2.swap1";
    final String fileStr2 = "html" + System.getProperty("file.separator") +"FogExample2.swap2";
    final String radLabel1 = " GL_EXP";
    final String radLabel2 = " GL_EXP2";
    /**
