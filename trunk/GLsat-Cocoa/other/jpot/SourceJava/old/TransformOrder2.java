...
public class TransformOrder2 extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "TransformOrder2.html";
	/**
	 * Name of the executable file illustrates for the example.
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "TransformOrder2";
	// End of the vary part.

		
	public TransformOrder2() {
		super(windowTitle);
		int i;
