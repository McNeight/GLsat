...
public class SpotLight extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "SpotLight.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "SpotLight";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "SpotLight.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Spot Const Att",0.0,5.0,1.5,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Spot Linear Att",0.0,5.0,0.5,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Spot Quad Att",0.0,5.0,0.2,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Spot CutOff",0.0,20.0,10.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Direction X",-5.0,5.0,2.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Direction Y",-5.0,5.0,0.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Direction Z",-5.0,5.0,-2.0,'c');
		vSlider.addElement(slider);
	}
