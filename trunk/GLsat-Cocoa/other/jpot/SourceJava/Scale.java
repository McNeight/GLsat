...
public class Scale extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "Scale.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "Scale";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "Scale.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X",-5.0,5.0,1.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Y",-5.0,5.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Z",-5.0,5.0,1.0,'c');
		vSlider.addElement(slider);
	}
