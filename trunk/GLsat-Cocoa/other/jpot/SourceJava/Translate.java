...
public class Translate extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "Translate.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "Translate";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "Translate.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("X",-5.0,5.0,0.0,'c');
