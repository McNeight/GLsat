...
public class DrawPoint extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "DrawPoint.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "DrawPoint";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "DrawPoint.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Point Size",1.0,5.0,3.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X0",0.0,30.0,5.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Y0",0.0,30.0,5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X1",0.0,30.0,10.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y1",0.0,30.0,20.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X2",0.0,30.0,20.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Y2",0.0,30.0,25.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("X3",0.0,30.0,25.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Y3",0.0,30.0,5.0,'c');
		vSlider.addElement(slider);
	}
