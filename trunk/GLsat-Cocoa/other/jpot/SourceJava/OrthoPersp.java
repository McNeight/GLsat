...
public class OrthoPersp extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "OrthoPersp.html";
	/**
	 * Number of sliders used in the frame.
	 */
	static int COMPONENTS = 12;
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "OrthoPersp";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "OrthoPersp.dat";
	...
	void createSliderVector() { 
		PSlider slider;
		slider = new PSlider("Frus-left",-5.0,5.0,-1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Frus-right",-5.0,5.0,1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Frus-bottom",-5.0,5.0,-1.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Frus-top",-5.0,5.0,1.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Frus-near",0.1,20.0,2.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Frus-far",0.1,30.0,20.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-left",-10.0,10.0,-5.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-right",-10.0,10.0,5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-bottom",-10.0,10.0,-5.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-top",-10.0,10.0,5.0,'n');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-near",-10.0,10.0,2.0,'c');
		vSlider.addElement(slider);
		slider = new PSlider("Orth-far",10.0,30.0,20.0,'c');
		vSlider.addElement(slider);
	}
