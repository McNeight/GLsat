...
public class ObjectColor extends JFrame {
	 ...
	 */
	static String exampleSource = "html" + System.getProperty("file.separator") + "ObjectColor.html";
	/**
	 ...
	 */
	String cmd = "ogl" + System.getProperty("file.separator") + "ObjectColor";
	
	/**
	 * Data file to provide interchance data during the interaction
	 */
	String dataFile = "ObjectColor.dat";
