...
GraphicsSetupTextureMaps(void)
{
  ...
  ifile.open("land_ocean_ice_1.ppm");
  if (ifile)
  {
    ifile >> earth1;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_2.ppm");
  if (ifile)
  {
    ifile >> earth2;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_4.ppm");
  if (ifile)
  {
    ifile >> earth4;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_8.ppm");
  if (ifile)
  {
    ifile >> earth8;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_16.ppm");
  if (ifile)
  {
    ifile >> earth16;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_32.ppm");
  if (ifile)
  {
    ifile >> earth32;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_64.ppm");
  if (ifile)
  {
    ifile >> earth64;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_128.ppm");
  if (ifile)
  {
    ifile >> earth128;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_256.ppm");
  if (ifile)
  {
    ifile >> earth256;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_512.ppm");
  if (ifile)
  {
    ifile >> earth512;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_1024.ppm");
  if (ifile)
  {
    ifile >> earth1024;
    ifile.close();
  ...
  ifile.open("land_ocean_ice_2048.ppm");
  if (ifile)
  {
    ifile >> earth2048;
    ifile.close();
